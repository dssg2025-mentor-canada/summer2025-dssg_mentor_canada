...
#### Remove `Prefer not to answer` / `Don't know` responses for following ordinal items
...
# ** All these unsure columns are categorical--they will be removed later--now we comment this part out:

# # remove responses with 'Unsure' entries (non-nominal columns)
# col_with_unsure <- c("QS1_2_PROV", "QS2_16_FORMAT_1", "QS1_4_INDIGENOUS", "QS2_16_FORMAT_2",
#                       "QS1_12_DISABIL", "QS2_16_FORMAT_3", "QS1_13_DISABIL", "QS2_24_MENTORAGE",
#                       "QS1_22_HIGHESTEDU", "QS2_28_MATCHCHOICE", "QS2_1_MEANINGFULP",
#                       "QS2_3_PRESENCEOFM", "QS4_17_SERVEDASM", "QS2_8_UNMETNEED61", "QS4_18_CURRENTOR",
#                       "QS2_9_PRESENCEOFA",  "QS2_12_UNMETNEED1", "QS4_25_FUTUREMEN", 
#                       "QS2_2_MEANINGFULP", "QS2_4_MENTOR61FOR")
# df_unsure <- youth |>
# filter_at(vars(all_of(col_with_unsure)), all_vars(!(. %in% "Unsure")))


# nrow(df_unsure) # 981 rows, removing a bit more than half of the data set:(
# ncol(df_unsure)
```

```{r}
# remove responses with 'Prefer not to say' entries (non-nominal columns)
# cols_with_pns <- c("QS1_2_PROV", "QS1_4_INDIGENOUS", "QS1_11_SEXUALO", "QS1_12_DISABIL", "QS1_13_DISABIL", "QS2_1_MEANINGFULP", "QS2_2_MEANINGFULP", "QS2_3_PRESENCEOFM", "QS2_4_MENTOR61FOR", "QS2_8_UNMETNEED61", "QS2_9_PRESENCEOFA", "QS2_12_UNMETNEED1", "QS2_16_FORMAT_1", "QS2_24_MENTORAGE", "QS2_28_MATCHCHOICE")

# df_unsure <- df_unsure |>
# filter_at(vars(all_of(cols_with_pns)), all_vars(!(. %in% "Prefer not to say")))
# nrow(df_unsure) # 922 rows
# ncol(df_unsure)
```

### Remove categorical columns in numeric encoding with levels corresponding to `Unsure` or `Prefer not to say`

`Unsure` or `Prefer not to say` are sometimes encoded as `Unsure = 4` or `Prefer not to say = 5`.

```{r}

## **** Come back and remove these categorical columns after ohe!

# cat_cols_pns_3ormore <- c(#"QS1_5_INDIGENOUSHS", "QS1_17_INCARE", "QS1_27_PLANNINGRE", "QS2_5_MENTOR611PR", 
#                           "QS2_7_MENTOR611SE", "QS2_11_MENTOR1218",  
#                           #'QS2_22_GEOLOCATI1', 'QS2_22_GEOLOCATI2', 'QS2_22_GEOLOCATI3',
#                           'QS3_4_LIFEEVENTS1_1_1', 'QS3_4_LIFEEVENTS1_2_2', 'QS3_4_LIFEEVENTS1_3_3', 'QS3_4_LIFEEVENTS1_4_4', 'QS3_4_LIFEEVENTS1_5_5',  'QS3_4_LIFEEVENTS1_6_6', 'QS3_4_LIFEEVENTS1_7_7', 'QS3_4_LIFEEVENTS1_8_8', 'QS3_4_LIFEEVENTS1_9_9', 'QS3_4_LIFEEVENTS1_10_10', 'QS3_4_LIFEEVENTS1_11_11', 'QS3_4_LIFEEVENTS1_12_12', 'QS3_4_LIFEEVENTS1_13_13', 'QS3_4_LIFEEVENTS1_14_14', 'QS3_4_LIFEEVENTS1_15_15', 'QS3_4_LIFEEVENTS1_16_16', 'QS3_4_LIFEEVENTS1_17_17', 'QS3_4_LIFEEVENTS1_18_18', 'QS3_4_LIFEEVENTS1_19_19', 'QS3_4_LIFEEVENTS1_20_20',  'QS4_6_DISAPPOINTED', 'QS4_13_LIFEEVE1_1_1', 'QS4_13_LIFEEVE1_2_2', 'QS4_13_LIFEEVE1_3_3',  'QS4_13_LIFEEVE1_4_4', 'QS4_13_LIFEEVE1_5_5', 'QS4_13_LIFEEVE1_6_6',  'QS4_16_FORMALVOL',  'QS4_14_FORMALVOL')
                  
# cat_cols_pns_4 <- c('QS4_1_MEANINGFULPERSON', # >=4 is unsure
# 'QS4_4_EDUCATIONALEXPEC', # 11 is unsure
# "QS4_21_MENTORING", "QS4_22_PASTMENTO"  # >=4 is unsure

#   #"QS4_26_INTERNETC", "QS4_27_INTERNETC1_1_1", "QS4_27_INTERNETC1_2_2", "QS4_27_INTERNETC1_3_3", "QS4_27_INTERNETC1_4_4", "QS4_30_INTERNETCON", "QS4_31_MOBILECONN", "QS4_32_MOBILECONNE1_2_2", "QS4_32_MOBILECONNE1_3_3", "QS4_32_MOBILECONNE1_4_4", "QS4_33_MOBILECONNECT") # these are internet access questions
 
```

```{r}
# df_unsure <- df_unsure |>
#  select(-c("QS1_5_INDIGENOUSHS", "QS1_17_INCARE", "QS1_27_PLANNINGRE", "QS2_5_MENTOR611PR", # program name
# 'QS2_22_GEOLOCATI1', 'QS2_22_GEOLOCATI2', 'QS2_22_GEOLOCATI3'))
# # df_unsure <- df_unsure |>
# # filter_at(vars(all_of(cat_cols_pns_3ormore)),  all_vars(!(.>= 3)))
# nrow(df_unsure) # 922 rows
```
...
> [**Important note for downstream analysis \*\*\*\*\***]{.underline}: Uncomment the above code block `youth <- df_unsure` if you want to use the unfiltered original data.
...
mean_mode_impute_test   <- bake(mean_mode_impute_prep, new_data = test_data)
```
...
```{r}
# >=3 is unsure/pnts:
cat_unsure_pnts_3_or_more <- c("QS1_5_INDIGENOUS", "QS1_5_INDIGENOUSHS", "QS1_17_INCARE", "QS1_27_PLANNINGRE", 
...
cat_unsure_pnts_4 <- c("QS4_1_MEANINGFULPERSON",
                       "QS4_21_MENTORING",
                       "QS4_22_PASTMENTO", 
                       "QS2_17_TYPE_1", 
                       "QS2_17_TYPE_2",
...
# Below are internet access questions:
cat_internet_access <- c("QS4_26_INTERNETC", "QS4_27_INTERNETC1_1_1", "QS4_27_INTERNETC1_2_2", "QS4_27_INTERNETC1_3_3", "QS4_27_INTERNETC1_4_4", "QS4_28_INTERNETCON", "QS4_29_PRIVATECONN",  "QS4_31_MOBILECONNE", "QS4_32_MOBILECONNE1_1_1", "QS4_32_MOBILECONNE1_2_2", "QS4_32_MOBILECONNE1_3_3", "QS4_32_MOBILECONNE1_4_4", "QS4_33_MOBILECONNECT")
...
```{r}
# Removal of cat_unsure_pnts_3_or_more

mean_mode_imputed_train <- mean_mode_imputed_train %>% 
  select(-matches(paste0("(", paste(cat_unsure_pnts_3_or_more, collapse = "|"), ")_(X3|X4)$|",
                         "(", paste(cat_unsure_pnts_4, collapse = "|"), ")_(X4|X5)$", 
                         "(", paste(cat_internet_access, collapse = "|"), ")_(X3|X4)$")))

ohe_unimputed_train <- ohe_unimputed_train %>% 
  select(-matches(paste0(
    "(", paste(cat_unsure_pnts_3_or_more, collapse = "|"), ")_(X3|X4)$|",
    "(", paste(cat_unsure_pnts_4, collapse = "|"), ")_(X4|X5)$|",
    "(", paste(cat_internet_access, collapse = "|"), ")_(X3|X4)$"
  )))
...
remaining_cols <- colnames(ohe_unimputed_train)[grepl("_X3$|_X4$", colnames(ohe_unimputed_train))]
print(remaining_cols) # correct!
```
...
write_feather(mean_mode_impute_test, "../../dssg-2025-mentor-canada/Data/mean_mode_imputed_test.feather")
